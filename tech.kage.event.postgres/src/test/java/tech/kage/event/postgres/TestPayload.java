...
public class TestPayload extends org.apache.avro.specific.SpecificRecordBase {
    ...
    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse(
            "{\"type\":\"record\",\"name\":\"TestPayload\",\"namespace\":\"tech.kage.event.postgres\",\"fields\":[{\"name\":\"text\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
     ...
     */
    public static tech.kage.event.postgres.TestPayload.Builder newBuilder() {
        return new tech.kage.event.postgres.TestPayload.Builder();
    }
     ...
     */
    public static tech.kage.event.postgres.TestPayload.Builder newBuilder(
            tech.kage.event.postgres.TestPayload.Builder other) {
        if (other == null) {
            return new tech.kage.event.postgres.TestPayload.Builder();
        } else {
            return new tech.kage.event.postgres.TestPayload.Builder(other);
        }
    }
     ...
     */
    public static tech.kage.event.postgres.TestPayload.Builder newBuilder(
            tech.kage.event.postgres.TestPayload other) {
        if (other == null) {
            return new tech.kage.event.postgres.TestPayload.Builder();
        } else {
            return new tech.kage.event.postgres.TestPayload.Builder(other);
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TestPayload> {
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(tech.kage.event.postgres.TestPayload.Builder other) {
            super(other);
         ...
         * @param other The existing instance to copy.
         */
        private Builder(tech.kage.event.postgres.TestPayload other) {
            super(SCHEMA$, MODEL$);
            if (isValidValue(fields()[0], other.text)) {
                this.text = data().deepCopy(fields()[0].schema(), other.text);
         ...
         * @return This builder.
         */
        public tech.kage.event.postgres.TestPayload.Builder setText(java.lang.String value) {
         ...
         * @return This builder.
         */
        public tech.kage.event.postgres.TestPayload.Builder clearText() {
            text = null;
